...
<head>
	...
	<link rel="icon" href="dist/img/logo3.png">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/logo4.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-2 pb-2 mb-2 d-flex">
					<div class="image">
						<img src="dist/img/user3.png" class="img-circle elevation-1" alt="User Image">
					</div>
					<div class="info">
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'view-pegawai':
					...
					break;
				case 'data-status':
					include "admin/pegawai/data_status1.php";
					break;
				case 'data-status-pegawai':
					include "admin/pegawai/data_status_pegawai.php";
					break;
